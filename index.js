...
// @clickIndex - int, the greatest index of userClickedPattern, the most recent color selected
// @output - void, sees if userClickedPattern[clickIndex] matches gamePattern[clickIndex]
//
function checkAnswer(clickIndex)
{
    ...
    {
        // output the procedure after wrong answer
        wrong();
        // reset the game with startOver function
        startOver();
    }
}


// @output - void, rests the values of global variables
//
function startOver() 
{
...
// @output - void, plays wrong sound and adds a game over style for 200 ms
//
function wrong()
{
    // play wrong sound
